...
HD_PWD='D:/Verilog/ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MIPS_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MIPS_Processor.tcl -notrace
